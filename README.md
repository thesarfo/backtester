A backtester that pulls real historical price data from, runs four trading strategies side by side, and opens an interactive visual dashboard in your browser when done.
